...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table">
		<tr>
			...
			<td><input name="dbname" id="dbname" type="text" size="25" value="<?php echo(isset($cba_baza) ? $cba_baza : 'wordpress');?>" /></td>
			<td><?php _e( 'The name of the database you want to use with WordPress.' ); ?></td>
		</tr>
		<tr>
			<th scope="row"><label for="uname"><?php _e( 'Username' ); ?></label></th>
			<td><input name="uname" id="uname" type="text" size="25" value="<?php echo (isset($cba_juzek) ? $cba_juzek : htmlspecialchars( _x( 'username', 'example username' ), ENT_QUOTES )); ?>" /></td>
		...
		<tr>
			...
			<td><input name="dbhost" id="dbhost" type="text" size="25" value="<?php echo (isset($cba_host) ? $cba_host : 'localhost');?>" /></td>
			<td><?php
